                    ...
                    <div className="row">
                        <div className="col-lg-7">
                            <div className="data">
                                ...
                                <form>
                                    ...
                                    <button type="submit" className="theme-btn">Send Message  <i className="fas fa-angle-double-right" /></button>
                                </form>
                            </div>
                        </div>
                        <div className="col-lg-4 offset-lg-1">
                            <div className="bio">
                                <div className="data">
                                    <figure>
                                        <img className="author" src="assets/images/bio.png" alt="Bio Image" />
                                    </figure>
                            ...
                            <div className="info">
                                <ul className="contact">
                                    <li>
                                        ...
                                        <div>
                                            <h3>Address:</h3>
                                            <p>36/F, Topsia Road, Offbeat CCU, 4th Floor, Room - 405, Kol - 39</p>
                                        </div>
                                    </li>
                                    <li>
