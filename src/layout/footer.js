                        ...
                        <div className="row">
                            <div className="footer-first">
                                <div className="footer-logo">
                                    <a href="index.html">
                                        <img src="assets/images/Paving-Logo1.png" alt="Footer Logo" />
                                    </a>
                                </div>
                                <div className="contact-info d-flex-all">
                                    ...
                                    <p>
                                        Sales representative <span>+91 88252 17361</span> free call
                                        !
                                    </p>
                                </div>
                ...
                <div className="footer-p-3 rights">
                    <div className="container">
                        <div className="row">
                            <div className="footer-col">
                                <p>
                                    Paving+ <i className="fas fa-heart" /> ©
                                    2022 All rights reserved. Design by <a href="https://www.linkedin.com/in/ashish-kumar-7a5b401ba/"> Ashish</a>
                                </p>
